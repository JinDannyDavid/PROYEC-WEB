// frontend/src/components/admin/PropiedadFilters.tsx
import { FaFilter, FaSearch, FaTimes } from 'react-icons/fa';

interface PropiedadFiltersProps {
  searchTerm: string;
  onSearchChange: (value: string) => void;
  selectedEstado: string;
  onEstadoChange: (value: string) => void;
  estadoOptions: { value: string; label: string; color?: string }[];
}

export default function PropiedadFilters({
  searchTerm,
  onSearchChange,
  selectedEstado,
  onEstadoChange,
  estadoOptions,
}: PropiedadFiltersProps) {
        ...
        <div className="flex-1 min-w-[200px]">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Buscar por medidor, dirección o propietario..."
